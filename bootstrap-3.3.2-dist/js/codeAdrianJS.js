$(document).ready(function () {
    ...
    function fadeIntroImages() {
        $("#img-intro").fadeTo(1200, 1).delay(3000).fadeTo(1200, 0, function () {
            $("#img-intro").attr('src', './resources/images/ca_intro_02.png').fadeTo(1200, 1).delay(3000).fadeTo(1200, 0, function () {
                $("#img-intro").attr('src', './resources/images/ca_intro_03.png').fadeTo(1200, 1).delay(3000).fadeTo(1200, 0, function () {
                    $("#img-intro").attr('src', './resources/images/ca_intro_01.png');
                    // repeat the function infinitely
                    fadeIntroImages();
                });
            });
        });
    ...
    //  - - - - - - - - - toggle functions for skills and galleries - - - - - - - - - 
    ...
    $("#a_C_Cpp").click(function () {
        $('html, body').animate({
            scrollTop: $("#box_C_Cpp").offset().top - 50
        }, 500);
    });

    $("#a_Csharp").click(function () {
        $('html, body').animate({
            scrollTop: $("#box_Csharp").offset().top - 50
        }, 500);
    });

    $("#a_HTML_CSS").click(function () {
        $('html, body').animate({
            scrollTop: $("#box_HTML_CSS").offset().top - 50
        }, 500);
    });

    $("#a_JS_JQ").click(function () {
        $('html, body').animate({
            scrollTop: $("#box_JS_JQ").offset().top - 50
        }, 500);
    });

    $("#a_PHP_lang").click(function () {
        $('html, body').animate({
            scrollTop: $("#PHP_lang").offset().top - 50
        }, 500);
    });

    $("#a_MySQL_DB").click(function () {
        $('html, body').animate({
            scrollTop: $("#MySQL_DB").offset().top - 50
        }, 500);
    });

    $("#a_Matlab").click(function () {
        $('html, body').animate({
            scrollTop: $("#Matlab").offset().top - 50
        }, 500);
    });

    $("#a_ASP_MVC").click(function () {
        $('html, body').animate({
            scrollTop: $("#ASP_MVC").offset().top - 50
        }, 500);
    });

    $("#a_frontend").click(function () {
        $('html, body').animate({
            scrollTop: $("#frontend_dev").offset().top - 50
        }, 500);
    });

    $("#a_backend").click(function () {
        $('html, body').animate({
            scrollTop: $("#backend_dev").offset().top - 50
        }, 500);
    });
    ...
    $(".a_technical_skills").click(function () {
        $('html, body').animate({
            scrollTop: $("#technical_skills").offset().top - 50
        }, 500);
    });

    $("#a_omnivision").click(function () {
        $('html, body').animate({
            scrollTop: $("#g_omnivision").offset().top - 50
        }, 500);
    });

    $("#a_hexagonal").click(function () {
        $('html, body').animate({
            scrollTop: $("#g_hexagonal").offset().top - 50
        }, 500);
    });

    $(".a_computerVision").click(function () {
        $('html, body').animate({
            scrollTop: $("#g_computerVision").offset().top - 50
        }, 500);
    });

    $("#a_imageToASCII").click(function () {
        $('html, body').animate({
            scrollTop: $("#g_imageToASCII").offset().top - 50
        }, 500);
    });

    $("#a_blockRunnerRampage").click(function () {
        $('html, body').animate({
            scrollTop: $("#g_blockRunnerRampage").offset().top - 50
        }, 500);
    });

    $("#a_foodlyApp").click(function () {
        $('html, body').animate({
            scrollTop: $("#g_foodlyApp").offset().top - 50
        }, 500);
    });

    $("#a_foodlyWeb").click(function () {
        $('html, body').animate({
            scrollTop: $("#g_foodlyWeb").offset().top - 50
        }, 500);
    });

    $("#a_easyLearn").click(function () {
        $('html, body').animate({
            scrollTop: $("#g_easyLearn").offset().top - 50
        }, 500);
    });

    $("#a_codeAdrianWeb").click(function () {
        $('html, body').animate({
            scrollTop: $("#g_codeAdrianWeb").offset().top - 50
        }, 500);
    });

    $("#a_kernelFlter").click(function () {
        $('html, body').animate({
            scrollTop: $("#g_kernelFlter").offset().top - 50
        }, 500);
    });

    $(".a_roboticsProjects").click(function () {
        $('html, body').animate({
            scrollTop: $("#g_roboticsProjects").offset().top - 50
        }, 500);
    });

    $("#a_histogram").click(function () {
        $('html, body').animate({
            scrollTop: $("#g_histogram").offset().top - 50
        }, 500);
    });
});